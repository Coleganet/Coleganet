...
App::$strings["Coleganet Notification"] = "Оповещения Red матрицы";
...
App::$strings["Coleganet - Guests: Username: {your email address}, Password: +++"] = "";
...
App::$strings["Coleganet - &quot;The Network&quot;"] = "";
App::$strings["Welcome to %s"] = "Добро пожаловать в %s";
App::$strings["Coleganet Server - Setup"] = "Coleganet Сервер - Установка";
...
App::$strings["In order to install Coleganet we need to know how to connect to your database."] = "";
...
App::$strings["Red"] = "Red";
App::$strings["This is a hub of the Coleganet - a global cooperative network of decentralised privacy enhanced websites."] = "";
App::$strings["Running at web location"] = "";
App::$strings["Please visit <a href=\"http://getzot.com\">GetZot.com</a> to learn more about the Coleganet."] = "Пожалуйста посетите <a href=\"http://getzot.com\">GetZot.com</a> чтобы узнать больше о Coleganet.";
App::$strings["Bug reports and issues: please visit"] = "";
App::$strings["Suggestions, praise, etc. - please email \"Coleganet\" at librelist - dot com"] = "";
...
App::$strings["You are cordially invited to join me and some other close friends on the Coleganet - a revolutionary new decentralised communication and information tool."] = "";
...
App::$strings["Once you have registered (on ANY Coleganet site - they are all inter-connected), please connect with my Coleganet channel address:"] = "";
App::$strings["Click the [Register] link on the following page to join."] = "";
App::$strings["For more information about the Coleganet Project and why it has the potential to change the internet as we know it, please visit http://getzot.com"] = "Чтобы узнать больше о проекте Coleganet, и чтобы узнать почему он имеет потенциал для изменения привычного нам Интернета, пожалуйста, посетите http://getzot.com";
...
App::$strings["Create an account to access services and applications within the Coleganet"] = "";
