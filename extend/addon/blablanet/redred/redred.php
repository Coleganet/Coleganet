...
/**
 * Name: Coleganet Crosspost Connector (redred)
 * Description: Relay public postings to another Redmatrix/Coleganet channel
 * Version: 1.0
 * Maintainer: none
 */
 
/*
 *   Coleganet to Coleganet
 */
...
function redred_settings(&$a,&$s) {
	...
	$sc .= replace_macros(get_markup_template('field_checkbox.tpl'), array(
		'$field'	=> array('redred_enable', t('Allow posting to another Coleganet Channel'), $checked, '', array(t('No'),t('Yes'))),
	));

	$sc .= replace_macros(get_markup_template('field_checkbox.tpl'), array(
		'$field'	=> array('redred_default', t('Send public postings to Coleganet channel by default'), $defchecked, '', array(t('No'),t('Yes'))),
	));

	$sc .= replace_macros(get_markup_template('field_input.tpl'), array(
		'$field'	=> array('redred_baseapi', t('Coleganet API Path'), $api, t('https://{sitename}/api'))
	));

	$sc .= replace_macros(get_markup_template('field_input.tpl'), array(
		'$field'	=> array('redred_username', t('Coleganet login name'), $username, t('Email'))
	));

	$sc .= replace_macros(get_markup_template('field_input.tpl'), array(
		'$field'	=> array('redred_channel', t('Coleganet channel name'), $channel, t('Nickname'))
	));

	$sc .= replace_macros(get_markup_template('field_password.tpl'), array(
		'$field'	=> array('redred_password', t('Coleganet password'), $password, '')
	));

	$s .= replace_macros(get_markup_template('generic_addon_settings.tpl'), array(
		'$addon' 	=> array('redred', '<img src="images/hz-32.png" style="width:auto; height:1em; margin:-3px 5px 0px 0px;">' . t('Coleganet Crosspost Settings'), '', t('Submit')),
		'$content'	=> $sc
	));
