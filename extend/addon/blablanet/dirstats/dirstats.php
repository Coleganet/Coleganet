...
* This will list the number of Coleganet, Friendica and Diaspora
...
if (argv(1) == 'json') { 
	...
	$tpl = get_markup_template( "dirstats.tpl", "addon/dirstats/" );
	 return replace_macros($tpl, array(
        '$title' => t('Coleganet Directory Stats'),
        '$hubtitle' => t('Total Hubs'),
		'$hubcount' => $hubcount,
        '$zotlabel' => t('Coleganet Hubs'),
		'$zotcount' => $zotcount,
        '$friendicalabel' => t('Friendica Hubs'),
		'$friendicacount' => $friendicacount,
        '$diasporalabel' => t('Diaspora Pods'),
		'$diasporacount' => $diasporacount,
        '$zotchanlabel' => t('Coleganet Channels'),
		'$channelcount' => $channelcount,
