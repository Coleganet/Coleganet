...
/*   GNU social Plugin for Coleganet
 *
...
class StatusNetOAuth extends TwitterOAuth {
   ...
   * @return API results
   *
   * Copied here from the twitteroauth library and complemented by applying the proxy settings of Coleganet
   */
...
function statusnet_settings(&$a,&$s) {
	...
	if ( (!$ckey) && (!$csecret) ) {
		...
		$sc .= '<div class="section-content-info-wrapper">';
		$sc .= t('No consumer key pair for GNU social found. Register your Coleganet Account as an desktop client on your GNU social account, copy the consumer key pair here and enter the API base root.<br />Before you register your own OAuth key pair ask the administrator if there is already a key pair for this Coleganet installation at your favourite GNU social installation.');
		$sc .= '</div>';
