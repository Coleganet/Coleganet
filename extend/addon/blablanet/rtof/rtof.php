...
/**
 * Name: Coleganet-to-Friendica Connector (rtof)
...
function rtof_settings(&$a,&$s) {
	...
	$s .= replace_macros(get_markup_template('generic_addon_settings.tpl'), array(
		'$addon' 	=> array('rtof', '<img src="addon/rtof/friendica.png" style="width:auto; height:1em; margin:-3px 5px 0px 0px;">' . t('Coleganet to Friendica Post Settings'), '', t('Submit')),
		'$content'	=> $sc
	));
}
...
function rtof_post_hook(&$a,&$b) {
	...
	logger('Coleganet-to-Friendica post invoked');
	...
	$postdata = array('status' => $b['body'], 'title' => $b['title'], 'message_id' => $b['mid'], 'source' => 'Coleganet');
