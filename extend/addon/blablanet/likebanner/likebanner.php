...
/**
 * Name: Like Banner
 * Description: Creates a "like us on Coleganet" banner 
 * Version: 1.1
	...
	if($_REQUEST['addr']) {
		...
		if($channel) {
			...
			if($p) {
				...
				$html = '<a href="' . $link . '" ><img src="' . z_root() . '/likebanner?f=&addr=' . $def . '&size=' . $_REQUEST['size'] . '" alt="' . t('Like us on Coleganet') . '" /></a>';
