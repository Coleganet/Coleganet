...
function status_app_menu($a,&$b) {
    $b['app_menu'][] = '<div class="app-title"><a href="status">Coleganet Server Status and Help</a></div>';
}
...
<br><br>
<p align="left"> 
<object width="975" height="900" data="https://support.coleganet.com/"></object>
</p>
<br><br>
