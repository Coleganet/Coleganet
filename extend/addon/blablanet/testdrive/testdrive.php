...
/**
 * Name: testdrive
 * Description: Sample Coleganet plugin/addon for creating a test drive site with automatic account expiration.
 * Version: 1.1
...
function testdrive_enotify(&$a, &$b) {
    if (x($b, 'params') && $b['params']['type'] == NOTIFY_SYSTEM 
        ...
        $b['body'] = sprintf( t("Hi %1\$s,\n\nYour test account on %2\$s will expire in less than five days. We hope you enjoyed this test drive and use this opportunity to find or install a permanent hub and migrate your account to it. A list of public hubs is available at https://Coleganet.org/pubsites - and for more information on setting up your own $Projectname hub please see the project website at https://geditlab.com/coleganet/BlaBlanet ."), $b['recipient']['xchan_name'], "[url=" . z_root() . "]" . $b['sitename'] . "[/url]");
    }
}
