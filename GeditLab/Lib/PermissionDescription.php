...
class PermissionDescription  {
	...
	public function get_permission_icon() {
		...
		switch($this->channel_perm) {			
			...
			case PERMS_NETWORK:  return 'fa-share-alt-square'; // fa-share-alt-square is very similiar to the Coleganet logo, but we should create our own logo class to use
