...
// The Coleganet CalDAV client will store calendar information in the 'cal' DB table. 
...
// store our Coleganet password. Currently for testing we are using HTTP BASIC-AUTH and must initialise the 
