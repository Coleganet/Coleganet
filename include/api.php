...
require_once('include/api_auth.php');
	...
	/*
	 *
	 * Coleganet API. Loosely based on and possibly compatible with Twitter-Like (v1.0) API but all similarities end there. 
	 *
	 */
...
// @fixme - update for Coleganet extensible perms using abconfig or find a better way to do it
