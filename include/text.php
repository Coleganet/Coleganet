...
/**
 * @brief Logging function for Coleganet.
 *
 * Logging output is configured through Coleganet's system config. The log file
...
function get_tags($s) {
	...
	// fail to link the longer string. Coleganet github issue #378
...
function list_smilies() {
	...
	$icons = array(
		...
		'<img class="smiley" src="' . z_root() . '/images/bb-16.png" alt=":coleganet" />',
